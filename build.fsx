...
let project = "MongoDB F# Driver"
let authors = ["Max Hirschhorn"]
let summary = "F# driver for MongoDB."
let description = "F# driver for MongoDB."
let tags = "F# fsharp bson mongodb mongo"

let gitHome = "https://github.com/visemet"
let gitName = "mongo-fsharp-driver-prototype"
...
Target "AssemblyInfo" <| fun () ->
    for file in !! "src/AssemblyInfo*.fs" do
        ...
        let title =
            ...
            |> replace "AssemblyInfo" "FSharp.MongoDB"
        let versionSuffix = ".0"
...
Target "CleanTests" <| fun () ->
    CleanDirs [ "tests/FSharp.MongoDB.Bson.Tests/bin"
                ...
                "tests/FSharp.MongoDB.Driver.FunctionalTests/bin"
                "tests/FSharp.MongoDB.Driver.FunctionalTests/obj"
